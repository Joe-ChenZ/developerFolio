...
const greeting = {
  username: "Joe Chen",
  title: "Hello Y'all, this is Joe!",
  subTitle: emoji(
    "A passionate App / Software Developer 🚀 having an experience of building applications with Android Studio / JavaScript / Reactjs / React Native and some other cool libraries and frameworks."
  ),
  resumeLink:
    "https://drive.google.com/file/d/1Wx1HQKzr9466A6gjhiDHx_Rdg1JDjMOO/view?usp=sharing", // Set to empty to hide the button
...
const socialMediaLinks = {
  github: "https://github.com/Joe-ChenZ",
  linkedin: "https://www.linkedin.com/in/zhao-chen-4686221a0/",
  gmail: "zchen827@gatech.edu",
  ...
  schools: [
    {
      ...
      desc: "Hello! I major in Computer Science with specializations in Intelligence and Info-network.",
      descBullets: [
        "I do Android App development for my VIP team, using Android Studio, Firebase, HERE Maps API. ",
        "I participate in machine learning projects such as Tetris reinforcement training, scene classifications and semantic segmentations",
...
const workExperiences = {
  ...
  experience: [
    {
      role: "Student Assistant in Software Engineering",
      company: "Georgia Tech, Smart Community Corps",
      companylogo: require("./assets/images/GT_word_logo.png"),
      date: "May 2022 - August 2022",
      desc: "I was invovled in building a shuttle bus app for the local transportation service MARTA called Marta-REACH",
      descBullets: [
...
const contactInfo = {
  ...
  email_address: "joechenzhao1@gmail.com"
};
